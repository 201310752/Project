...
<!-- Header -->
  <header id="header">
    <div class="container-fluid">
      ...
      <div class="form_icon">
        <form id="form" action="">
          <input type="text" name="search" tooltip="search" placeholder="">
        </form> 
      </div>
  </header><!-- #header -->
<!-- intro section -->
      ...
      <div id="container">
        ...
        <div id="controls">
          ...
          <div class="control-group">
            <div class="control">
              <select id="vehicle-selector" title="Vehicle type">
              </select>
            </div>
    
            <div class="control">
              <div class="label">Bovine:</div>
              <input id="hour-selector" type="range" min="0" max="11" step="1" title="Adjust">
            </div>
            <div class="control">
              <div class="label">Caprine & Ovine:</div>
              <input id="day-selector" type="range" min="0" max="6" step="1" title="Adjusts">
            </div>
            <div class="control">
              <div class="label">Number dead:</div>
              <input id="month-selector" type="range" min="0" max="11" step="1" title="Adjusts">
            </div>
            <div class="control">
              <label for="animate" title="Toggles time animation.">animate</label>
              <input id="animator-toggle" type="checkbox" title="Toggles time animation." name="animate">
            </div>
          </div>
    
          <div class="control-group" >
            <div id="state" title="Date and time of current view">
              <div id="displayed-hour" style="display:none"></div>
              <div id="displayed-day" style="display:none"></div>
              <div id="displayed-month"></div>
              <div id="displayed-year"></div>
            </div>
        ...
        <div id="map">
          <canvas id="map-canvas" width="600" height="598"></canvas>
          <div id="scale-container">
            <div id="scale" title="Scale of risk in a region">
              <div class="low-risk-scale-label">low</div>
              <div class="high-risk-scale-label">high</div>
            </div>
            <div>Risk</div>
          </div>
        </div>
